        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TextKey = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoleHierarchies", x => new { x.ParentRoleId, x.ChildRoleId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Translations_LanguageId_TextKey",
                table: "Translations",
                columns: new[] { "LanguageId", "TextKey" },
                unique: true);
